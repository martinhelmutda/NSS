# Generated by Django 2.1.1 on 2018-11-04 22:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol_location', models.ManyToManyField(through='project_app.project_rol', to='project_app.project')),
            ],
        ),
        migrations.AddField(
            model_name='project_rol',
            name='rol',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='rols', to='project_app.rolInfo'),
        ),
        migrations.AddField(
            model_name='project',
            name='pro_roles',
